...
\begingroup
  ...
  \begin{picture}(9118.00,4320.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \colorrgb{0.00,0.00,0.00}%
      \put(860,440){\makebox(0,0){\strut{}-20}}%
      \colorrgb{0.00,0.00,0.00}%
      \put(2176,440){\makebox(0,0){\strut{}-15}}%
      \colorrgb{0.00,0.00,0.00}%
      \put(3492,440){\makebox(0,0){\strut{}-10}}%
      \colorrgb{0.00,0.00,0.00}%
      \put(4809,440){\makebox(0,0){\strut{}-5}}%
      \colorrgb{0.00,0.00,0.00}%
      \put(6125,440){\makebox(0,0){\strut{}0}}%
      \colorrgb{0.00,0.00,0.00}%
    ...
    \gplbacktext
    \put(0,0){\includegraphics{tabu-calidad-entrenamiento}}%
    \gplfronttext
  \end{picture}%
\endgroup
