...
\begingroup
  ...
  \begin{picture}(9118.00,4320.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \colorrgb{0.00,0.00,0.00}%
      \put(1988,440){\makebox(0,0){\strut{}0.1}}%
      \colorrgb{0.00,0.00,0.00}%
      \put(3116,440){\makebox(0,0){\strut{}0.2}}%
      \colorrgb{0.00,0.00,0.00}%
      \put(4244,440){\makebox(0,0){\strut{}0.3}}%
      \colorrgb{0.00,0.00,0.00}%
      \put(5373,440){\makebox(0,0){\strut{}0.4}}%
      \colorrgb{0.00,0.00,0.00}%
      \put(6501,440){\makebox(0,0){\strut{}0.5}}%
      \colorrgb{0.00,0.00,0.00}%
      \put(7629,440){\makebox(0,0){\strut{}0.6}}%
      \colorrgb{0.00,0.00,0.00}%
      ...
      \put(4808,4019){\makebox(0,0){\strut{}Heur\'istica Local: tiempo de ejecuci\'on}}%
    }%
